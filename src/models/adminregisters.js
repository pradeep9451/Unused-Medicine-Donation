...
//generating tokens
adminregistration.methods.generateAuthToken = async function () {
    try {
...
adminregistration.pre("save", async function(next){
...
const Adminregister = new mongoose.model("Admin", adminregistration);
